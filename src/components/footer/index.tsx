...
import { SiFacebook, SiInstagram, SiSinaweibo, SiTwitter, SiWechat } from "react-icons/si"
    ...
    return (
        <FooterContainer>
            <Wrapper>
                ...
                <InnerContainer>
                    <LeftInnerContainer>
                        <Menu>
                            ...
                            <MenuItem>
                                <Link to="Home">Travel Guides</Link>
                            </MenuItem>
                        </Menu>
                        <Menu>
                            <MenuItem>
                ...
                <BottomSection>
                    <Copyright>
                        Copyright @ { new Date().getFullYear() } Traveler  All rights reserved.
                    </Copyright>
                    <SmallText>
