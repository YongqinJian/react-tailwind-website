  ...
  return <TopSectionContainer>
    <LandingSection>
      ...
      <InfoSection>
        ...
        <FloatingText>FIJI.</FloatingText>
        <DescriptionText>
        The South Pacific archipelago of the Fiji islands is blessed with pure white sand beaches and crystal blue waters, 
        making it a perfect place for romance, escapism or simple relaxation. From nature excursions to watersports, boat trips, and snorkeling,
         explore and enjoy a perfect trip!
        </DescriptionText>
      </InfoSection>
      <ViewMoreButton>
